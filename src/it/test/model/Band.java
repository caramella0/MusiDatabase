...
public class Band {
	...
	public void setTitoloBand(String titoloBand) {
		this.titoloBand = titoloBand;
	}

	public String getGenereBand() {
		return genereBand;
	}

	public void setGenereBand(String genereBand) {
